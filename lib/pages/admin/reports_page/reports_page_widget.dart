...
class _ReportsPageWidgetState extends State<ReportsPageWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.generateReportOnApp = await GenerateReportFromDbCall.call(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        'Objetos de Mtto. Programados vs. Objetos de Mtto Identificados',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        'Mttos. Programados vs. Mttos Ejecutados',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.roboto(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        'Objetos de Mtto. con estado OPERATIVO vs. Mttos Ejecutados ',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.roboto(
                                  ...
                                  if (FFAppState().currentProject ==
                                      '0c930497-7018-434d-a839-b7d7714fe6fa')
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 10.0, 0.0, 0.0),
                                      child: Column(
                                                ...
                                                child: Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 0.0, 10.0, 0.0),
                                                  child: Text(
                                                    'Exportar Inventario Manual de Activos en Inventario',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Elige un rango de fechas teniendo en cuenta el año en cusro para generar un informe en PDF.',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily:
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            valueOrDefault<
                                                                String>(
                                                              functions.formatDateForReporting(_model
                                                                  .datePicked1
                                                                  ?.toString()),
                                                              'FECHA INICIAL',
                                                            ),
                                          ...
                                          child: Container(
                                            ...
                                            child: wrapWithModel(
                                              ...
                                              child:
                                                ...
                                                buttonText:
                                                    'Exportar infome a PDF',
                                                requiredAction: () async {
                                                  _model.generateReportFromDB =
                                                      await GenerateReportFromDbCall
                                                          .call(
                                                    startDate: functions
                                                        .formatDateForReporting(
                                                            _model.datePicked1
                                                                ?.toString()),
                                                    endDate: functions
                                                        .formatDateForReporting(
                                                  ...
                                                  if ((_model
                                                          ...
                                                          ?.succeeded ??
                                                      true)) {
                                                    _model.generatePDFReportWeb =
                                                        await CreateReportOrInventoryFromMakeCall
                                                            .call(
                                                      numberOfScheduledMaintenances:
                                                          GenerateReportFromDbCall
                                                              .odemsProgrammed(
                                                        (_model.generateReportFromDB
                                                                ?.jsonBody ??
                                                      ...
                                                      numberOfMaintenanceObjectsWithMttos:
                                                          GenerateReportFromDbCall
                                                              .odemsProgrammed(
                                                        (_model.generateReportFromDB
                                                                ?.jsonBody ??
                                                      ...
                                                      numberOfOperativeMaintenanceObjects:
                                                          GenerateReportFromDbCall
                                                              .odemsOperative(
                                                        (_model.generateReportFromDB
                                                                ?.jsonBody ??
                                                      ...
                                                      endDate: functions
                                                          .formatDateForReporting(
                                                              _model.datePicked2
                                                                  ?.toString()),
                                                      objectsInventoryJson: <String,
                                                          dynamic>{},
                                                      action: 'report',
                                                    );

                                                    if ((_model
                                                            .generatePDFReportWeb
                                                            ?.succeeded ??
                                                        true)) {
                                                        ...
                                                        builder:
                                                          ...
                                                          return AlertDialog(
                                                            title: Text(
                                                                'Algo salió mal'),
                                                            content: Text(
                                                                'Hubo un error generando el reporte'),
                                                            actions: [
                                                              TextButton(
                                                                onPressed: () =>
                                                                    Navigator.pop(
