          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Builder(
                  builder: (context) {
                    if (_model.selectedTab == 'INVENTORY') {
                      return Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            16.0, 0.0, 16.0, 12.0),
                        child: InkWell(
                ...
                Builder(
                  builder: (context) {
                    if (_model.selectedTab == 'REPORTS') {
                      ...
                      return Visibility(
                        visible: (FFAppState().authenticatedRole == 1) ||
                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.asset(
                                        'assets/images/disicheck-admin-user-creation-placeholder.png',
                                        width: 44.0,
                                        height: 44.0,
                                        fit: BoxFit.cover,
                                      ),
