...
class StandardHomeViewDesktopWidget extends StatefulWidget {
  const StandardHomeViewDesktopWidget({
    super.key,
    int? scheduledMttos,
    int? failuresFound,
    int? failuresFixed,
        ...
        this.failuresFixed = failuresFixed ?? 0;

  final int scheduledMttos;
  final int failuresFound;
  final int failuresFixed;

  @override
  State<StandardHomeViewDesktopWidget> createState() =>
      _StandardHomeViewDesktopWidgetState();
}

class _StandardHomeViewDesktopWidgetState
    extends State<StandardHomeViewDesktopWidget> with TickerProviderStateMixin {
  late StandardHomeViewDesktopModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StandardHomeViewDesktopModel());
