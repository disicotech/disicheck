...
class UnassignedObjectsTable extends SupabaseTable<UnassignedObjectsRow> {
  @override
  String get tableName => 'unassigned_objects';

  @override
  UnassignedObjectsRow createRow(Map<String, dynamic> data) =>
      UnassignedObjectsRow(data);
}

class UnassignedObjectsRow extends SupabaseDataRow {
  UnassignedObjectsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => UnassignedObjectsTable();
